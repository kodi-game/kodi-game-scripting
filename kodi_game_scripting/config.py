...
ADDONS = {
    ...
    'vice_x128':                 ('kodi-game/vice-libretro',    'Makefile',          '.',                 'jni', {'soname': 'vice_x128', 'cmake_options': 'EMUTYPE=x128'}),
    'vice_x64':                  ('kodi-game/vice-libretro',    'Makefile',          '.',                 'jni', {'soname': 'vice_x64', 'cmake_options': 'EMUTYPE=x64'}),
    'vice_x64dtv':               ('kodi-game/vice-libretro',    'Makefile',          '.',                 'jni', {'soname': 'vice_x64dtv', 'cmake_options': 'EMUTYPE=x64dtv'}),
    'vice_x64sc':                ('kodi-game/vice-libretro',    'Makefile',          '.',                 'jni', {'soname': 'vice_x64sc', 'cmake_options': 'EMUTYPE=x64sc'}),
    'vice_xcbm2':                ('kodi-game/vice-libretro',    'Makefile',          '.',                 'jni', {'soname': 'vice_xcbm2', 'cmake_options': 'EMUTYPE=xcbm2'}),
    'vice_xcbm5x0':              ('kodi-game/vice-libretro',    'Makefile',          '.',                 'jni', {'soname': 'vice_xcbm5x0', 'cmake_options': 'EMUTYPE=xcbm5x0'}),
    'vice_xpet':                 ('kodi-game/vice-libretro',    'Makefile',          '.',                 'jni', {'soname': 'vice_xpet', 'cmake_options': 'EMUTYPE=xpet'}),
    'vice_xplus4':               ('kodi-game/vice-libretro',    'Makefile',          '.',                 'jni', {'soname': 'vice_xplus4', 'cmake_options': 'EMUTYPE=xplus4'}),
    'vice_xscpu64':              ('kodi-game/vice-libretro',    'Makefile',          '.',                 'jni', {'soname': 'vice_xscpu64', 'cmake_options': 'EMUTYPE=xscpu64'}),
    'vice_xvic':                 ('kodi-game/vice-libretro',    'Makefile',          '.',                 'jni', {'soname': 'vice_xvic', 'cmake_options': 'EMUTYPE=xvic'}),
