...
ADDONS = {
    ...
    'beetle-psx':                ('kodi-game/beetle-psx-libretro', 'Makefile',       '.',                 'jni', {'soname': 'mednafen_psx'}),
    'beetle-psx-hw':             ('kodi-game/beetle-psx-libretro', 'Makefile',       '.',                 'jni', {'soname': 'mednafen_psx_hw', 'cmake_options': 'HAVE_OPENGL=1'}),
    ...
    'dolphin':                   ('dolphin',                    '',                  '',                  '', {'cmake': True, 'cmake_options': '-DLIBRETRO=ON -DENABLE_X11=OFF -DENABLE_HWDB=OFF -DENABLE_EVDEV=OFF -DENABLE_EGL=OFF -DCMAKE_BUILD_TYPE=Release'}),
    ...
    'flycast':                   ('flyinghead/flycast',         'Makefile',          '.',                 'jni', {'cmake': True, 'cmake_options': '-DLIBRETRO=ON'}),
    ...
    'lrps2':                     ('ps2',                        '',                  '.',                 '', {'cmake': True, 'branch': 'libretroization', 'soname': 'pcsx2', 'cmake_options': '-DPACKAGE_MODE=ON -DBIN_DIR=lib/libretro'}),
    ...
    'ppsspp':                    ('hrydgard/ppsspp',            'Makefile',          'libretro',          'libretro/jni', {}),
    ...
    'stella':                    ('stella-emu/stella',          'Makefile',          'src/os/libretro',   'src/os/libretro/jni', {'commit': '9bbd209f4a9505b1cd58242fa4b6790da020adcb'}),
    ...
    'uae4arm':                   ('Chips-fr/uae4arm-rpi',       'Makefile.libretro', '.',                 '', {
        'cmake_options': 'DEPS_PREFIX=${ADDON_DEPENDS_PATH}',
        'cmake_options_osx': 'MINVERSION=-mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}',
        'exclude_platforms': ['osx-x86_64', 'windows-i686', 'windows-x86_64'],
        'platform_android_aarch64': 'android-aarch64',
        'platform_android_arm': 'android-armv7',
        'platform_linux_aarch64': 'unix-aarch64',
        'platform_linux_arm': 'unix-neon',
        'platform_osx_arm64': 'osx-arm64',
        'use_cmake_compilers_android': True,
        'use_cmake_compilers_osx': True,
    }),
    ...
    'virtualjaguar':             ('virtualjaguar-libretro',     'Makefile',          '.',                 'jni', {'cmake_options_osx_x86_64': 'BLITTER_SIMD=sse2'}),
